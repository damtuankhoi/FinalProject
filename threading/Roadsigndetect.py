...
def identifyTrafficSign(image):
    ...
    cv2.imshow('Left', leftBlock)
    cv2.imshow('Center', centerBlock)
    cv2.imshow('Right', rightBlock)
    cv2.imshow('Top', topBlock)
...
def main():
    video_path = 'FinalProject/threading/RoadSign.mp4'
    ...
    while True:
        # Lấy frame hình hiện tại từ camera
